import { useGetComplianceRulesQuery, useGetPayrollSettingsQuery, useGetSalaryProcessingQuery, useGetAiPayrollHealthScoreQuery, useGetAiPayrollAnomaliesQuery } from "@/features/payroll";
...
export function usePayrollMiscData(activeTab: string) {
  ...
  return {
    ...
    isSettingsLoading, backendSettings, reportsAnalyticsRes, aiHealthRes, aiAnomaliesRes,
  };
}
