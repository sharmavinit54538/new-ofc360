...
const DEFAULT_SHIFTS: ShiftTemplate[] = [
  ...
  },
  {
    ...
    fullDayHours: 8.0,
    breakDurationMins: 45,
    department: "Customer Support & Facilities",
  },
  {
    id: "SHF-03",
    ...
    fullDayHours: 8.0,
    breakDurationMins: 45,
    department: "24/7 Security & IT Infrastructure",
  },
];
...
const DEFAULT_HOLIDAYS: HolidayItem[] = [
  ...
  },
  {
    ...
    date: "2026-02-15",
    type: "Public",
    branchLocation: "Headquarters (HQ)",
    mandatory: false,
  },
  {
    id: "HOL-04",
...
export const useAttendanceStore = create<AttendanceState>((set, get) => ({
  ...
  shifts: getStoredData<ShiftTemplate[]>(STORAGE_KEYS.SHIFTS, DEFAULT_SHIFTS),
  rosters: getStoredData<RosterItem[]>(STORAGE_KEYS.ROSTERS, []),
  holidays: getStoredData<HolidayItem[]>(STORAGE_KEYS.HOLIDAYS, DEFAULT_HOLIDAYS),
