...
export function StatutoryRegisterCard({ complianceFilings }: { complianceFilings?: any[] }) {
  const safeFilings = Array.isArray(complianceFilings) ? complianceFilings : [];
  return (
