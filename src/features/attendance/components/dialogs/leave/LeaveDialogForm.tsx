...
export function LeaveDialogForm(p: any) {
  return (
    <div className="space-y-3 py-2">
      ...
      <div><Label className="text-xs">Reason for Leave</Label><Textarea value={p.leaveReason} onChange={(e) => p.setLeaveReason(e.target.value)} placeholder="Provide short justification..." className="text-xs mt-1 min-h-[60px]" /></div>
    </div>
  );
}
