...
export const aiApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getAiDashboardResumeDocumentId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/ai/dashboard/${paramsresume_document_id` : typeof params === 'object' && params?.id ? `/api/v1/ai/dashboard/{resume_document_id}` : '/api/v1/ai/dashboard/{resume_document_id}',
    ...
    getAiJobRankingJobId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/ai/job-ranking/${paramsjob_id` : typeof params === 'object' && params?.id ? `/api/v1/ai/job-ranking/{job_id}` : '/api/v1/ai/job-ranking/{job_id}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['AI'],
    }),
    ...
    getAiHistoryConversationId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/ai/history/${paramsconversation_id` : typeof params === 'object' && params?.id ? `/api/v1/ai/history/{conversation_id}` : '/api/v1/ai/history/{conversation_id}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['AI'],
    }),
