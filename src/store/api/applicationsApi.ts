...
export const applicationsApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getApplicationsId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/applications/${params}` : typeof params === 'object' && params?.id ? `/api/v1/applications/${params.id}` : '/api/v1/applications/{id}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Application'],
    }),
    updateApplicationsIdShortlist: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/applications/${data}/shortlist` : typeof data === 'object' && data?.id ? `/api/v1/applications/${data.id}/shortlist` : '/api/v1/applications/{id}/shortlist',
        method: 'PATCH',
    ...
    updateApplicationsIdReject: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/applications/${data}/reject` : typeof data === 'object' && data?.id ? `/api/v1/applications/${data.id}/reject` : '/api/v1/applications/{id}/reject',
        method: 'PATCH',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Application'],
    ...
    updateApplicationsIdHold: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/applications/${data}/hold` : typeof data === 'object' && data?.id ? `/api/v1/applications/${data.id}/hold` : '/api/v1/applications/{id}/hold',
        method: 'PATCH',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Application'],
    ...
    updateApplicationsIdStage: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/applications/${data}/stage` : typeof data === 'object' && data?.id ? `/api/v1/applications/${data.id}/stage` : '/api/v1/applications/{id}/stage',
        method: 'PATCH',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Application'],
