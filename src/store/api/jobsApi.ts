...
export const jobsApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getJobsId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/jobs/${paramsid` : typeof params === 'object' && params?.id ? `/api/v1/jobs/${params.id}` : '/api/v1/jobs/{id}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Job'],
    }),
    ...
    getPublicCareersSlug: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/public/careers/${paramsslug` : typeof params === 'object' && params?.id ? `/api/public/careers/{slug}` : '/api/public/careers/{slug}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Job'],
    }),
