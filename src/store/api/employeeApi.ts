...
export const employeeApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getEmployeesId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/employees/${paramsid` : typeof params === 'object' && params?.id ? `/api/v1/employees/${params.id}` : '/api/v1/employees/{id}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Employee'],
    }),
    ...
    getEmployeesIdOnboardingStatus: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/employees/${paramsid/onboarding-status` : typeof params === 'object' && params?.id ? `/api/v1/employees/${params.id}/onboarding-status` : '/api/v1/employees/{id}/onboarding-status',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Employee'],
    }),
