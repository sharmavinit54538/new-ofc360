...
export const eventsApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getEventsId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/events/${params}` : typeof params === 'object' && params?.id ? `/api/v1/events/${params.id}` : '/api/v1/events/{id}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Event'],
    }),
    updateEventsId: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/events/${data}` : typeof data === 'object' && data?.id ? `/api/v1/events/${data.id}` : '/api/v1/events/{id}',
        method: 'PUT',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Event'],
    ...
    updateEventsIdPublish: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/events/${data}/publish` : typeof data === 'object' && data?.id ? `/api/v1/events/${data.id}/publish` : '/api/v1/events/{id}/publish',
        method: 'PATCH',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Event'],
    ...
    updateEventsIdCancel: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/events/${data}/cancel` : typeof data === 'object' && data?.id ? `/api/v1/events/${data.id}/cancel` : '/api/v1/events/{id}/cancel',
        method: 'PATCH',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Event'],
    ...
    createEventsIdRegister: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/events/${data}/register` : typeof data === 'object' && data?.id ? `/api/v1/events/${data.id}/register` : '/api/v1/events/{id}/register',
        method: 'POST',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Event'],
