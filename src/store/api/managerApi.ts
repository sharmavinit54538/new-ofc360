...
export const managerApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getManagersId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/managers/${params}` : typeof params === 'object' && params?.id ? `/api/v1/managers/${params.id}` : '/api/v1/managers/{id}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Manager'],
    }),
    updateManagersId: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/managers/${data}` : typeof data === 'object' && data?.id ? `/api/v1/managers/${data.id}` : '/api/v1/managers/{id}',
        method: 'PUT',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Manager'],
    ...
    createManagersIdSendInvitation: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/managers/${data}/send-invitation` : typeof data === 'object' && data?.id ? `/api/v1/managers/${data.id}/send-invitation` : '/api/v1/managers/{id}/send-invitation',
        method: 'POST',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Manager'],
    ...
    createManagersIdActivate: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/managers/${data}/activate` : typeof data === 'object' && data?.id ? `/api/v1/managers/${data.id}/activate` : '/api/v1/managers/{id}/activate',
        method: 'POST',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Manager'],
    ...
    createManagersIdResetPassword: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/managers/${data}/reset-password` : typeof data === 'object' && data?.id ? `/api/v1/managers/${data.id}/reset-password` : '/api/v1/managers/{id}/reset-password',
        method: 'POST',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Manager'],
    ...
    createManagersIdDeactivate: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/managers/${data}/deactivate` : typeof data === 'object' && data?.id ? `/api/v1/managers/${data.id}/deactivate` : '/api/v1/managers/{id}/deactivate',
        method: 'POST',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Manager'],
    ...
    createManagersIdActivateByAdmin: builder.mutation<ApiResponse<any>, any>({
      query: (data) => ({
        url: typeof data === 'string' || typeof data === 'number' ? `/api/v1/managers/${data}/activate-by-admin` : typeof data === 'object' && data?.id ? `/api/v1/managers/${data.id}/activate-by-admin` : '/api/v1/managers/{id}/activate-by-admin',
        method: 'POST',
        body: typeof data === 'object' ? data : undefined,
      }),
      invalidatesTags: ['Manager'],
