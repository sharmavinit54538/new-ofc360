...
export const departmentApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getDepartmentsId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/departments/${paramsid` : typeof params === 'object' && params?.id ? `/api/v1/departments/${params.id}` : '/api/v1/departments/{id}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Department'],
    }),
    ...
    getDepartmentsIdEmployees: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/departments/${paramsid/employees` : typeof params === 'object' && params?.id ? `/api/v1/departments/${params.id}/employees` : '/api/v1/departments/{id}/employees',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Department'],
    }),
    getDepartmentsIdManager: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/departments/${paramsid/manager` : typeof params === 'object' && params?.id ? `/api/v1/departments/${params.id}/manager` : '/api/v1/departments/{id}/manager',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Department'],
    }),
    getDepartmentsIdStats: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/departments/${paramsid/stats` : typeof params === 'object' && params?.id ? `/api/v1/departments/${params.id}/stats` : '/api/v1/departments/{id}/stats',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Department'],
    }),
