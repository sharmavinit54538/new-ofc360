...
export const exitsApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getExitsId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/exits/${paramsid` : typeof params === 'object' && params?.id ? `/api/v1/exits/${params.id}` : '/api/v1/exits/{id}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Exit'],
    }),
    ...
    getExitsIdAssets: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/exits/${paramsid/assets` : typeof params === 'object' && params?.id ? `/api/v1/exits/${params.id}/assets` : '/api/v1/exits/{id}/assets',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Exit'],
    }),
    ...
    getExitsIdDocuments: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/exits/${paramsid/documents` : typeof params === 'object' && params?.id ? `/api/v1/exits/${params.id}/documents` : '/api/v1/exits/{id}/documents',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Exit'],
    }),
