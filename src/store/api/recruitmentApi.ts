...
export const recruitmentApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getRequisitionsId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/requisitions/${paramsid` : typeof params === 'object' && params?.id ? `/api/v1/requisitions/${params.id}` : '/api/v1/requisitions/{id}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Candidate'],
    }),
    ...
    getVendorsId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/vendors/${paramsid` : typeof params === 'object' && params?.id ? `/api/v1/vendors/${params.id}` : '/api/v1/vendors/{id}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Candidate'],
    }),
    ...
    getCrmNotesCandidateId: builder.query<ApiResponse<any>, any>({
      query: (params) => ({
        url: typeof params === 'string' || typeof params === 'number' ? `/api/v1/crm/notes/${paramscandidate_id` : typeof params === 'object' && params?.id ? `/api/v1/crm/notes/{candidate_id}` : '/api/v1/crm/notes/{candidate_id}',
        params: typeof params === 'object' ? params : undefined,
      }),
      providesTags: ['Candidate'],
    }),
